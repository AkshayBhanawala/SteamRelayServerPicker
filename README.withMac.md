...
*Note: While automated builds are generated for macOS and Linux,  Currently I've only tested the application on Windows 11. Mac and Linux builds are provided "as-is".*
...
- **Linux Verification?** \
I'm afraid I do not have a timeline for this. Since I am unable to test on Linux at the moment due to device unavailability. And I don't wanna change anything in my current system atm for my own sake.
